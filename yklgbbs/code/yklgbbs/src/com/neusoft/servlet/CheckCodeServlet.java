...
@WebServlet("/checkCodeServlet.do")
public class CheckCodeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	//设置验证图片的宽度, 高度, 验证码的个数
	private int width = 152;
	private int height = 40;
	private int codeCount = 4;  //说明生成4个验证码，可以自己改
...
//	char [] codeSequence = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz23456789".toCharArray();
	char [] codeSequence = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefhiklmnopqrstuvwxyz23456789".toCharArray();
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		//随机产生 30 条干扰线, 使图像中的认证码不易被其它程序探测到
		Random random = null;
		random = new Random();
		...
		*/
		...
		request.getSession().setAttribute("checkCode", temp);
