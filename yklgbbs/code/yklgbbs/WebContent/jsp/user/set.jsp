    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
          ...
          <form action="${pageContext.request.contextPath}/setuser.do" method="post">
          
           <div class="layui-form-item">
              <label for="L_email" class="layui-form-label">邮箱</label>
              <div class="layui-input-inline">
              
              <input value="${sessionScope.userInfo.email}" type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" value="" class="layui-input">
               
             <!--  <input disabled="disabled" style="background:#e7e7e7" type="text"  class="layui-input"> -->
              </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input value="${sessionScope.userInfo.nickname}" type="text" id="L_username" name="nickName" required lay-verify="required" autocomplete="off" value="" class="layui-input">
              </div>
              <div class="layui-inline">
                <div class="layui-input-inline">
                  <input type="radio" name="sex" value="0" <c:if test="${sessionScope.userInfo.sex==0}">checked</c:if>  title="男">
                  <input type="radio" name="sex" value="1" <c:if test="${sessionScope.userInfo.sex==1}">checked</c:if> title="女">
                </div>
              </div>
            </div>
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input value="${sessionScope.userInfo.city}" type="text" id="L_city" name="city" autocomplete="off" value="" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item layui-form-text">
              <label for="L_sign" class="layui-form-label">签名</label>
              <div class="layui-input-block">
                <textarea placeholder="随便写些什么刷下存在感吧" id="L_sign"  name="sign" autocomplete="off" class="layui-textarea" style="height: 80px;">${sessionScope.userInfo.signName}</textarea>
              </div>
            </div>
            <div class="layui-form-item">
              <!-- <button class="layui-btn" key="set-mine" lay-filter="*" lay-submit>确认修改</button> -->
              <input type="submit" class="layui-btn" key="set-mine" lay-submit value="确认修改">
            </div>
          </div>
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
            ...
            <form action="${pageContext.request.contextPath }/changePass.do" method="post">
              <div class="layui-form-item">
          ...
          <div class="layui-form layui-form-pane layui-tab-item">
          	<div style="font-size:20px;" id="no_collect" class="fly-none">该功能还在路上！敬请期待</div>
            <ul class="app-bind">
